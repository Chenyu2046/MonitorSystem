...
void TestQueryProtoMapping() {
  ...
  softirq.hi = 101.0F;
  softirq.timer = 102.0F;
  softirq.net_tx = 103.0F;
  softirq.net_rx = 104.0F;
  softirq.block = 105.0F;
  softirq.irq_poll = 106.0F;
  softirq.tasklet = 107.0F;
  softirq.sched = 108.0F;
  softirq.hrtimer = 109.0F;
  softirq.rcu = 110.0F;
  ...
  assert(softirq_output.hi_per_sec() == 101.0F);
  assert(softirq_output.timer_per_sec() == 102.0F);
  assert(softirq_output.net_tx_per_sec() == 103.0F);
  assert(softirq_output.net_rx_per_sec() == 104.0F);
  assert(softirq_output.block_per_sec() == 105.0F);
  assert(softirq_output.irq_poll_per_sec() == 106.0F);
  assert(softirq_output.tasklet_per_sec() == 107.0F);
  assert(softirq_output.sched_per_sec() == 108.0F);
  assert(softirq_output.hrtimer_per_sec() == 109.0F);
  assert(softirq_output.rcu_per_sec() == 110.0F);
